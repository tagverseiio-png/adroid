    ...
    return (
        <>
            ...
            <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-40 flex flex-col gap-4 items-end">
                ...
                >
                    <a
                        href="https://wa.me/918807436688"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center w-[52px] h-[52px] bg-[#25D366] text-white rounded-full shadow-2xl transition-colors duration-500"
                        aria-label="WhatsApp us"
                        title="WhatsApp +91 88074 36688"
                    >
