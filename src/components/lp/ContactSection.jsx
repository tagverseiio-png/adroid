export default function ContactSection({ onOpenModal, data = {} }) {
  const {
    headline = "Ready to Design &amp; Build Your Dream Home?",
    sub_headline = "&ldquo;Click below to request your free architectural consultation. Our team will review your project brief and get back to you within one business day.&rdquo;",
    ...
    <section id="contact" className="py-16 lg:py-24 bg-white border-b border-[#ECE7DF] scroll-mt-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#FBF9F5] border border-[#ECE7DF] rounded-2xl p-8 sm:p-12 shadow-xl text-center space-y-6">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#2C1D11] max-w-2xl mx-auto" style={{ fontFamily: "'Cormorant Garamond', serif" }} dangerouslySetInnerHTML={{ __html: headline }}>
          </h2>

          <p className="text-[#66605B] text-base sm:text-lg max-w-xl mx-auto leading-relaxed" dangerouslySetInnerHTML={{ __html: sub_headline }}></p>
