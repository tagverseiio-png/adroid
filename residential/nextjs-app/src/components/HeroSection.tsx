        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6 lg:gap-8 order-2 lg:order-1">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-[#2C1D11]">
                Residential Construction Company
              </span>
            </div>

            <h1 className="font-bold text-4xl lg:text-5xl text-[#2C1D11] leading-tight" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Residential Construction <br />Contractors Chennai
            </h1>

            <p className="text-lg font-semibold text-[#B85A32]">
              Design &amp; Build Your Dream Home With Adroit Designs
            </p>

            <p className="text-base text-[#66605B] leading-relaxed border-l-4 border-[#ECE7DF] pl-4">
              &ldquo;Adroit Design designs and builds homes end‑to‑end — residential architecture, interiors and turnkey construction for villas, independent houses and apartments, from the first sketch to the final handover.&rdquo;
            </p>

            <div className="flex flex-wrap gap-6 text-sm font-semibold text-[#2C1D11] border-l-4 border-[#B85A32] pl-4 py-1">
              <span>15+ Years Experience</span>
              <span className="text-[#B85A32]">500+ Homes Designed</span>
              <span>End-to-End Solutions</span>
            </div>

            <div className="flex flex-wrap gap-2">
              {["Independent Houses", "Villas", "Apartment Interiors", "Home Renovation", "Turnkey Construction"].map((tag) => (
                <span key={tag} className="text-xs bg-[#ECE7DF]/50 text-[#242220] px-3 py-1 rounded border border-[#ECE7DF]">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 group">
            <div className="relative min-h-[420px] sm:min-h-[520px] lg:min-h-[640px] w-full overflow-hidden rounded-lg shadow-2xl bg-[#ECE7DF]/30">
              <Image
                src="/hero_image.jpeg"
                alt="Adroit Designs residential construction project"
                fill
